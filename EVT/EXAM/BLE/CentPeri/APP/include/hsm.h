...
#define STATE_CTOR_STATIC(S, NAME, SUPER, HNDLR) State S = { .name = NAME, .super = SUPER, .hndlr = HNDLR}
...
void HsmCtorByTopState(Hsm *me, char const *name, State const * const p_top);
